  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute inset-0 bg-green-500 rounded-full opacity-20" style={{
          animation: 'ping 3s cubic-bezier(0, 0, 0.2, 1) infinite'
        }}></div>
      </button>

      <div className="fixed bottom-24 right-6 z-50 bg-zinc-900 text-white px-3 py-2 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
